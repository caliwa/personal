  ...
  <aside class="max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-4 block w-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 
    ...
    <div class="h-19.5">
      <i class="absolute top-0 right-0 hidden p-4 opacity-50 cursor-pointer fas fa-times text-slate-400 xl:hidden"
        sidenav-close></i>
      <a wire:navigate
        class="block px-8 py-6 m-0 text-size-sm whitespace-nowrap text-slate-700" href="{{ route('dashboard-cerrajeria') }}" target="_blank">
        <img src="../assets/img/logo-ct.png"
          class="inline h-full max-w-full transition-all duration-200 ease-nav-brand max-h-8" alt="main_logo" />
        <span
          class="{{ (Request::is('rtl') ? 'mr-1' : 'ml-1') }} font-semibold transition-all duration-200 ease-nav-brand">El Progreso</span>
      </a>
    </div>
      ...
      <ul class="flex flex-col pl-0 mb-0">
        <li class="mt-0.5 w-full">
          <a wire:navigate
            ...
            href="{{ route('dashboard-cerrajeria') }}">
            ...
            <span
              class="{{ (Request::is('rtl') ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">Sede Medellín</span>
          </a>
        </li>
        ...
        <li class="mt-0.5 w-full">
          <a 
            ...
            <span
              class="{{ (Request::is('rtl') ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">Mi Usuario</span>
          </a>
        </li>
        ...
        <li class="mt-0.5 w-full">
          <a wire:navigate
            ...
            <span
              class="{{ (Request::is('rtl') ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">Moldes</span>
          </a>
        </li>
        ...
        <li class="mt-0.5 w-full">
          <a wire:navigate
            ...
            <span
              class="{{ (Request::is('rtl') ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">Pasarela Pago</span>
          </a>
        </li>
        ...
        <li class="mt-0.5 w-full">
          <a wire:navigate
            ...
            <span
              class="{{ (Request::is('rtl') ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">Gestión Inventario</span>
          </a>
        </li>
        ...
        <li class="mt-0.5 w-full">
          <a wire:navigate 
            ...
            <span
              class="{{ (Request::is('rtl') ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">Mantenimiento</span>
          </a>
        </li>
        ...
        <li class="mt-0.5 w-full">
          <a wire:navigate
            ...
            <span
              class="{{ (Request::is('rtl') ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">Interesados Campaña</span>
          </a>
        </li>
        ...
        <li class="mt-0.5 w-full">
          <a wire:navigate
            ...
            <span
              class="{{ (Request::is('rtl') ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">Cerrar Sesión</span>
          </a>
        </li>
      </ul>
    </div>
