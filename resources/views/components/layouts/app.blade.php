...
<body class="bg-white overflow-x-hidden" x-data="{ 
    ...
    <nav class="border-b-4 border-red-300/50 py-4 px-6 md:px-12 flex justify-between items-center sticky top-0 bg-white/20 backdrop-blur-md shadow-lg shadow-red-200/20 z-50">
            ...
            <div class="hidden md:flex space-x-8">
                ...
                <a wire:navigate wire:current.exact='pointer-events-none decoration-4 decoration-red-400 text-red-900' href="/pitch" class="font-medium text-black hover:text-red-900 hover:underline decoration-4 decoration-red-400 underline-offset-8 transition-all duration-300">Pitch</a>
...
>
    <div class="flex flex-col py-4 px-6">
        ...
        <a wire:navigate wire:current.exact='pointer-events-none decoration-4 decoration-red-400 text-red-900' href="/pitch" class="font-medium py-3 border-b border-gray-200 hover:bg-gray-100 px-2">Pitch</a>
