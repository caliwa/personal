                            ...
                            <div
                                ...
                                <div class="p-6 pb-0 mb-0 bg-transparent border-b-0 rounded-t-2xl">
                                    <h3 class="relative z-10 font-bold text-transparent bg-gradient-cyan bg-clip-text">
                                        ¡Bienvenido de vuelta!</h3>
                                    <p class="mb-0">Entra a la plataforma<br>Con tu usuario asignado</p>
                                </div>
                                ...
                                <div class="flex-auto p-6">
                                    ...
                                    <form wire:submit="login">
                                        ...
                                        <label class="mb-2 ml-1 font-bold text-size-xs text-slate-700">Correo Electrónico</label>
                                        <div class="mb-4">
                                        ...
                                        @enderror
                                        <label class="mb-2 ml-1 font-bold text-size-xs text-slate-700">Contraseña</label>
                                        <div class="mb-4">
                                        ...
                                        <div class="text-center">
                                            <button type="submit"
                                                class="inline-block w-full px-6 py-3 mt-6 mb-0 font-bold text-center text-white uppercase align-middle transition-all bg-transparent border-0 rounded-lg cursor-pointer shadow-soft-md bg-x-25 bg-150 leading-pro text-size-xs ease-soft-in tracking-tight-soft bg-gradient-cyan hover:scale-102 hover:shadow-soft-xs active:opacity-85">Iniciar
                                                Sesión</button>
                                        </div>
                                    </form>
                                </div>
                                <div
                                    ...
                                    <p class="mx-auto mb-6 leading-normal text-size-sm">
                                        ¿Olvidaste tu contraseña? Escríbele a T.I. 
                                        <a 
                                            class="relative z-10 font-semibold text-transparent bg-gradient-cyan bg-clip-text">aquí</a>.<br />
                                        ¿No tienes una cuenta?
                                        <a 
                                            class="relative z-10 font-semibold text-transparent bg-gradient-cyan bg-clip-text">Solicita ingreso</a>.
                                    </p>
                                </div>
                            </div>
                        </div>
