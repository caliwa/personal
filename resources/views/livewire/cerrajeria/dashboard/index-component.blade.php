<div>
                ...
                <div class="flex-auto p-4">
                    <div class="flex flex-row -mx-3">
                        <div class="flex-none w-2/3 max-w-full px-3">
                            <div>
                                <p class="mb-0 font-sans font-semibold leading-normal text-size-sm">Ingresos semana</p>
            ...
            <div class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
                <div class="flex-auto p-4">
                    <div class="flex flex-row -mx-3">
                        <div class="flex-none w-2/3 max-w-full px-3">
                            <div>
                                <p class="mb-0 font-sans font-semibold leading-normal text-size-sm">Clientes hoy</p>
                                <h5 class="mb-0 font-bold">
                                    2,300
        ...
        <div class=" w-full max-w-full px-3 mb-6 sm:w-1/2 sm:flex-none xl:mb-0 xl:w-1/4">
            <div class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
                <div class="flex-auto p-4">
                    <div wire:click="openModal"  class="cursor-pointer flex flex-row -mx-3">
                        <div class="flex-none w-2/3 max-w-full px-3">
                            <div>
                                <p class="mb-0 font-sans font-semibold leading-normal text-size-sm">Nuevos proyectos Madera</p>
                                <h5 class="mb-0 font-bold">
                                    +15
            ...
            <div class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
                <div class="flex-auto p-4">
                    <div class="flex flex-row -mx-3">
                        <div class="flex-none w-2/3 max-w-full px-3">
                            <div>
                                <p class="mb-0 font-sans font-semibold leading-normal text-size-sm">Ventas día</p>
                                <h5 class="mb-0 font-bold">
                                    $COP 1,003,430.53
                                    <span
    ...
    <div class="flex flex-wrap mt-6 -mx-3">
        <div class="w-full px-3 mb-6 lg:mb-0 lg:w-7/12 lg:flex-none">
            <div class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
                <div class="flex-auto p-4">
                    <div class="flex flex-wrap -mx-3">
                          <div class="bg-gradient-to-r from-blue-600 to-blue-800 h-2"></div>
        
        <div class="p-6 flex flex-col h-96">
            <!-- Header con icono -->
            <div class="flex items-center mb-4">
                ...
                <div>
                    <h5 class="text-xl font-bold text-gray-800 leading-tight">
                        Cerrajería El Progreso LL S.A.S.
                    </h5>
                    <p class="text-sm text-blue-600 font-medium">Fabricación Especializada</p>
                </div>
            </div>

            <!-- Servicios principales -->
            <div class="flex-grow mb-6">
                <h6 class="font-semibold text-gray-700 mb-3 uppercase tracking-wide text-sm">
                    Nuestros Servicios:
                </h6>
                
                <div class="space-y-2 text-sm text-gray-600 leading-relaxed">
                    <div class="flex items-start">
                        <i class="fas fa-door-open text-blue-500 mt-1 mr-2 flex-shrink-0"></i>
                        <span><strong>Puertas y Ventanas</strong> en lámina y aluminio con pintura electrostática</span>
                    </div>
                    
                    <div class="flex items-start">
                        <i class="fas fa-shower text-blue-500 mt-1 mr-2 flex-shrink-0"></i>
                        <span><strong>Cabinas de Baño</strong> en aluminio y vidrio templado</span>
                    </div>
                    
                    <div class="flex items-start">
                        <i class="fas fa-stairs text-blue-500 mt-1 mr-2 flex-shrink-0"></i>
                        <span><strong>Pasamanos</strong> personalizados</span>
                    </div>
                    
                    <div class="flex items-start">
                        <i class="fas fa-cut text-blue-500 mt-1 mr-2 flex-shrink-0"></i>
                        <span><strong>Servicios de Corte y Doblez</strong> de materiales</span>
                    </div>
                    
                    <div class="flex items-start">
                        <i class="fas fa-th-large text-blue-500 mt-1 mr-2 flex-shrink-0"></i>
                        <span><strong>Tableros Troquelados</strong></span>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-auto">
                <div class="border-t">
                    <a href="#" class="flex items-center justify-between group hover:bg-gray-50 -mx-2 px-2 py-2 rounded-lg transition-colors duration-200">
                        <div class="flex items-center">
                            <div class="bg-gray-100 p-2 rounded-lg mr-3 group-hover:bg-blue-100 transition-colors duration-200">
                                <i class="fas fa-map-marker-alt text-gray-600 group-hover:text-blue-600 transition-colors duration-200 mt-10"></i>
                            </div>
                            <div>
                                <p class="font-semibold text-gray-800 text-sm">Ubicación</p>
                                <p class="text-gray-600 text-sm">Cra. 53 #57-39</p>
                            </div>
                        </div>
                        <i class="fas fa-arrow-right text-gray-400 group-hover:text-blue-600 group-hover:translate-x-1 transition-all duration-200"></i>
                    </a>
                </div>
            </div>
        </div>
     ...
     src="https://png.pngtree.com/png-vector/20230413/ourmid/pngtree-locksmith-flat-icon-vector-png-image_6703379.png"
     alt="locksmith icon" />
            ...
            <div
                ...
                <div class="relative h-full overflow-hidden bg-cover rounded-xl"
                    ...
                    <div class="relative z-10 flex flex-col flex-auto h-full p-4">
                        <h5 class="pt-2 mb-6 font-bold text-white">Misión/Visión</h5>
                        <p class="text-white">Somos una empresa de Medellín dedicada a brindar soluciones integrales en seguridad a través de cerraduras de alta calidad, innovadoras y confiables. Nos comprometemos con la tranquilidad de nuestros clientes, ofreciendo productos y servicios que protegen hogares, empresas y vehículos, respaldados por un equipo humano capacitado y cercano.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="w-full max-w-full px-3 mt-0 mb-6 lg:mb-0 lg:w-5/12 lg:flex-none">
            <div
                ...
                <div class="flex-auto p-4">
                    ...
                    <h6 class="mt-6 mb-0 ml-2">Usuarios activos</h6>
                    <p class="ml-2 leading-normal text-size-sm">(<span class="font-bold">+23%</span>) más que la semana pasada
                    </p>
                        ...
                        <div class="flex flex-wrap mt-0 -mx-3">
                            <div class="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                                <div class="flex mb-2">
                                    ...
                                    <p class="mt-1 mb-0 font-semibold leading-tight text-size-xs">Usuarios</p>
                                </div>
                            ...
                            <div class="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                                <div class="flex mb-2">
                                    ...
                                    <p class="mt-1 mb-0 font-semibold leading-tight text-size-xs">Última Venta</p>
                                </div>
                                <h4 class="font-bold">$45,300.00</h4>
                                <div class="text-size-xs h-0.75 flex w-3/4 overflow-visible rounded-lg bg-gray-200">
        ...
        <div class="w-full max-w-full px-3 mt-0 lg:w-7/12 lg:flex-none">
            <div
                ...
                <div class="border-black/12.5 mb-0 rounded-t-2xl border-b-0 border-solid bg-white p-6 pb-0">
                    <h6>Informe Gerencia</h6>
                    <p class="leading-normal text-size-sm">
                        <i class="fa fa-arrow-up text-lime-500"></i>
                        <span class="font-semibold">4% más</span> que en 2025 ... Sección en mantenimiento (A/B)
                    </p>
                </div>
                <div class="flex-auto p-4">
                    <div>
    ...
    <div class="flex flex-wrap my-6 -mx-3">
                    ...
                    <div class="flex flex-wrap mt-0 -mx-3">
                        <div class="flex-none w-7/12 max-w-full px-3 mt-0 lg:w-1/2 lg:flex-none">
                            ...
                            <p class="mb-0 leading-normal text-size-sm">
                                ...
                                <span class="ml-1 font-semibold">30 cerrados</span>
                                en este mes
                            </p>
                        </div>
                                    ...
                                    <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                                        <div class="flex px-2 py-1">
                                            ...
                                            <div class="flex flex-col justify-center">
                                                <h6 class="mb-0 leading-normal text-size-sm">Gobernación Antioquía
                                                </h6>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                                        <div class="flex px-2 py-1">
                                            ...
                                            <div class="flex flex-col justify-center">
                                                <h6 class="mb-0 leading-normal text-size-sm">Chiringuito S.A
                                                </h6>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                                        <div class="flex px-2 py-1">
                                            ...
                                            <div class="flex flex-col justify-center">
                                                <h6 class="mb-0 leading-normal text-size-sm">Nutresa
                                                </h6>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                                        <div class="flex px-2 py-1">
                                            ...
                                            <div class="flex flex-col justify-center">
                                                <h6 class="mb-0 leading-normal text-size-sm">Coliseo Sabaneta
                                                </h6>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td class="p-2 align-middle bg-transparent border-0 whitespace-nowrap">
                                        <div class="flex px-2 py-1">
                                            ...
                                            <div class="flex flex-col justify-center">
                                                <h6 class="mb-0 leading-normal text-size-sm"> La Mega 104.1 FM
                                                    </h6>
                                            </div>
                                        </div>
                                    </td>
        ...
        <div class="w-full max-w-full px-3 md:w-1/2 md:flex-none lg:w-1/3 lg:flex-none">
            <div
                ...
                <div class="border-black/12.5 mb-0 rounded-t-2xl border-b-0 border-solid bg-white p-6 pb-0">
                    <h6>Revisión de ordenes</h6>
                    <p class="leading-normal text-size-sm">
                        <i class="fa fa-arrow-up text-lime-500"></i>
                        <span class="font-semibold">24%</span> este mes
                    </p>
                </div>
                <div class="flex-auto p-4">
                    <div
                        ...
                        <div class="relative mb-4 mt-0 after:clear-both after:table after:content-['']">
                            ...
                            <div class="ml-11.252 pt-1.4 lg:max-w-120 relative -top-1.5 w-auto">
                                <h6 class="mb-0 font-semibold leading-normal text-size-sm text-slate-700">$2400,
                                    Cambios diseño</h6>
                                <p class="mt-1 mb-0 font-semibold leading-tight text-size-xs text-slate-400">22 MAYO
                                    7:20 PM</p>
                            </div>
                        </div>
                        <div class="relative mb-4 after:clear-both after:table after:content-['']">
                            ...
                            <div class="ml-11.252 pt-1.4 lg:max-w-120 relative -top-1.5 w-auto">
                                <h6 class="mb-0 font-semibold leading-normal text-size-sm text-slate-700">Nueva Orden
                                    #1832412</h6>
                                <p class="mt-1 mb-0 font-semibold leading-tight text-size-xs text-slate-400">21 MAYO
                                    11 PM</p>
                            </div>
                        </div>
                        <div class="relative mb-4 after:clear-both after:table after:content-['']">
                            ...
                            <div class="ml-11.252 pt-1.4 lg:max-w-120 relative -top-1.5 w-auto">
                                <h6 class="mb-0 font-semibold leading-normal text-size-sm text-slate-700">Pagos hosting web</h6>
                                <p class="mt-1 mb-0 font-semibold leading-tight text-size-xs text-slate-400">21 MAYO
                                    9:34 PM</p>
                            </div>
                        </div>
                        <div class="relative mb-4 after:clear-both after:table after:content-['']">
                            ...
                            <div class="ml-11.252 pt-1.4 lg:max-w-120 relative -top-1.5 w-auto">
                                <h6 class="mb-0 font-semibold leading-normal text-size-sm text-slate-700">Transacción en espera #4395133</h6>
                                <p class="mt-1 mb-0 font-semibold leading-tight text-size-xs text-slate-400">20 MAYO
                                    2:20 AM</p>
                            </div>
                        </div>
                        <div class="relative mb-4 after:clear-both after:table after:content-['']">
                            ...
                            <div class="ml-11.252 pt-1.4 lg:max-w-120 relative -top-1.5 w-auto">
                                <h6 class="mb-0 font-semibold leading-normal text-size-sm text-slate-700">Cambio proveedor cerraduras</h6>
                                <p class="mt-1 mb-0 font-semibold leading-tight text-size-xs text-slate-400">18 MAYO
                                    4:54 AM</p>
                            </div>
                        </div>
                        <div class="relative mb-0 after:clear-both after:table after:content-['']">
                            ...
                            <div class="ml-11.252 pt-1.4 lg:max-w-120 relative -top-1.5 w-auto">
                                <h6 class="mb-0 font-semibold leading-normal text-size-sm text-slate-700">Abastecimiento inventario
                                    #9583120</h6>
                                <p class="mt-1 mb-0 font-semibold leading-tight text-size-xs text-slate-400">17 MAYO
                                </p>
                            </div>
                        </div>
                    </div>
